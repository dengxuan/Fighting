...
namespace Fighting.Caching.Abstractions
{
    ...
    public interface ICache : IDisposable
    {
        ...
        TEntity Get<TEntity>(string key, Func<string, TEntity> factory);
        ...
        /// <param name="factory">Factory method to create cache item if not exists</param>
        /// <returns>Cached item</returns>
        Task<object> GetAsync(string key, Func<string, object> factory);

        Task<TEntity> GetAsync<TEntity>(string key, Func<string, TEntity> factory);
        ...
        /// <param name="key">Key</param>
        /// <returns>Cached item or null if not found</returns>
        TEntity GetOrDefault<TEntity>(string key);
        ...
        /// <param name="key">Key</param>
        /// <returns>Cached item or null if not found</returns>
        Task<TEntity> GetOrDefaultAsync<TEntity>(string key);
        ...
        /// <param name="slidingExpireTime">Sliding expire time</param>
        /// <param name="absoluteExpireTime">Absolute expire time</param>
        void Set<TEntity>(string key, TEntity value, TimeSpan? slidingExpireTime = null, TimeSpan? absoluteExpireTime = null);
        ...
        /// <param name="slidingExpireTime">Sliding expire time</param>
        /// <param name="absoluteExpireTime">Absolute expire time</param>
        Task SetAsync(string key, Task<object> value, TimeSpan? slidingExpireTime = null, TimeSpan? absoluteExpireTime = null);
        ...
        /// <param name="slidingExpireTime">Sliding expire time</param>
        /// <param name="absoluteExpireTime">Absolute expire time</param>
        Task SetAsync<TEntity>(string key, Task<TEntity> value, TimeSpan? slidingExpireTime = null, TimeSpan? absoluteExpireTime = null);
