...
namespace Baibaocp.LotteryDispatching.Suicai.Abstractions.Extensions
{
    public static class LotteryCodeExtensions
    {
        public static string ToSuicaicode(this string code, OrderingDispatchMessage entity)
        {
            ...
            switch (entity.LvpOrder.LotteryId)
            {
                case (int)LotteryTypes.Dlt:
                    switch (entity.LvpOrder.LotteryPlayId)
                    {
                        ...
                        case (int)PlayTypes.Dlt_Multiple:
                            castcode = "1;" + entity.LvpOrder.LotteryPlayId.ToPlay(entity.LvpOrder.LotteryId, entity.LvpOrder.InvestType) + ";" + entity.LvpOrder.InvestTimes + ";" + code.Replace(',', '|').Replace("*", "|-") + "|-;";
                            break;
                    }
                    break;
                case (int)LotteryTypes.Ssq:
                    switch (entity.LvpOrder.LotteryPlayId)
                    {
                        ...
                        case (int)PlayTypes.Ssq_Multiple:
                            ...
                            castcode = "1;" + entity.LvpOrder.LotteryPlayId.ToPlay(entity.LvpOrder.LotteryId, entity.LvpOrder.InvestType) + ";" + entity.LvpOrder.InvestTimes + ";" + castcode.Replace(',', '|').Replace("*", "|-") + "|-;";
                            break;
                        case (int)PlayTypes.Ssq_FixedUnset:
                            ...
                            if (blue.Length == 1)
                            {
                                castcode = "1;" + entity.LvpOrder.LotteryPlayId.ToPlay(entity.LvpOrder.LotteryId, entity.LvpOrder.InvestType) + ";" + entity.LvpOrder.InvestTimes + ";" + castcode.Replace(",", "|").Replace("@", "|-").Replace("*", "|-") + "|-;";
                            }
                            else
                            {
                ...
                case (int)LotteryTypes.Sd:
                    switch (entity.LvpOrder.LotteryPlayId)
                    {
                        case (int)PlayTypes.Sd_FrontSingle:
                            castcode = "1;" + entity.LvpOrder.LotteryPlayId.ToPlay(entity.LvpOrder.LotteryId, entity.LvpOrder.InvestType) + ";" + entity.LvpOrder.InvestTimes + ";" + code.Replace("*", "|") + "|;";
                            break;
                ...
                case (int)LotteryTypes.GxKs:
                    switch (entity.LvpOrder.LotteryPlayId)
                    {
                        ...
                        case (int)PlayTypes.Ks_TowSameAll:
                            castcode = "1;" + entity.LvpOrder.LotteryPlayId.ToPlay(entity.LvpOrder.LotteryId, entity.LvpOrder.InvestType) + ";" + entity.LvpOrder.InvestTimes + ";" + code + "|" + code + "|255" + "|;";
                            break;
                        case (int)PlayTypes.Ks_ThreeSameAll:
                            castcode = "1;" + entity.LvpOrder.LotteryPlayId.ToPlay(entity.LvpOrder.LotteryId, entity.LvpOrder.InvestType) + ";" + entity.LvpOrder.InvestTimes + ";" + "255|255|255|;";
                            break;
                        case (int)PlayTypes.Ks_TowDiffSingle:
                            castcode = "1;" + entity.LvpOrder.LotteryPlayId.ToPlay(entity.LvpOrder.LotteryId, entity.LvpOrder.InvestType) + ";" + entity.LvpOrder.InvestTimes + ";" + code.Replace(",", "|") + "255|;";
                            break;
                ...
                case (int)LotteryTypes.JxKs:
                    switch (entity.LvpOrder.LotteryPlayId)
                    {
                        ...
                        case (int)PlayTypes.Ks_SumValue:
                            ...
                            break;
                        case (int)PlayTypes.Ks_ThreeSameAll:
                            castcode = "1;" + entity.LvpOrder.LotteryPlayId.ToPlay(entity.LvpOrder.LotteryId, entity.LvpOrder.InvestType) + ";" + entity.LvpOrder.InvestTimes + ";" + "111|222|333|444|555|666|;";
                            break;
                        case (int)PlayTypes.Ks_TowDiffSingle:
                            castcode = "1;" + entity.LvpOrder.LotteryPlayId.ToPlay(entity.LvpOrder.LotteryId, entity.LvpOrder.InvestType) + ";" + entity.LvpOrder.InvestTimes + ";" + code.Replace(",", "") + "|;";
                            break;
                        case (int)PlayTypes.Ks_ThreeSeriesAll:
                            castcode = "1;" + entity.LvpOrder.LotteryPlayId.ToPlay(entity.LvpOrder.LotteryId, entity.LvpOrder.InvestType) + ";" + entity.LvpOrder.InvestTimes + ";" + "123|234|345|456|;";
                            break;
                    }
                    break;
            }
