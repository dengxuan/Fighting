...
namespace Fighting.Storaging.Uow
{
    ...
    public abstract class UnitOfWork : IUnitOfWork
    {
        ...
        /// Constructor.
        /// </summary>
        protected UnitOfWork(IConnectionStringResolver connectionStringResolver, IUnitOfWorkDefaultOptions defaultOptions)
        {
        ...
        private void PreventMultipleBegin()
        {
            ...
            {
                throw new FightingException("This unit of work has started before. Can not call Start method more than once.");
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new FightingException("Complete is called before!");
            }
