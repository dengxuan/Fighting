...
namespace Baibaocp.LotteryDispatching.Linghang.Abstractions.Extensions
{
    public static class LotteryExtensions
    {
        public static int ToLinghangLottery(this int lotteryType)
        {
            switch (lotteryType)
            {
                case (int)LotteryTypes.Dlt:return 200;
                case (int)LotteryTypes.Pls: return 201;
                case (int)LotteryTypes.Plw: return 202;
                case (int)LotteryTypes.JcSpf:
                case (int)LotteryTypes.JcRqspf:
                case (int)LotteryTypes.JcBf:
                case (int)LotteryTypes.JcBqc:
                case (int)LotteryTypes.JcZjq:
                case (int)LotteryTypes.JcHun: return 400;
                case (int)LotteryTypes.LcDxf:
                case (int)LotteryTypes.LcSf:
                case (int)LotteryTypes.LcRfsf:
                case (int)LotteryTypes.LcSfc:
                case (int)LotteryTypes.LcHun: return 401;
